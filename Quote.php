						...
						<div class="row justify-content-center">
							...
							<div class="col-12">
								...
								<div class="table-responsive table-scroll" data-mdb-perfect-scrollbar="true" style="position: relative; height: 600px">
									...
									<table id="myDataTable" class="table table-striped table-bordered table-sm table-light border-primary">
											...
											?>
												...
												<tr class="gradeX">
													...
													<td class="center">
														...
														<?php } else { ?>
															<button onclick="modifyQuoteGlobalById(<?php echo $row['quoteIDHD']; ?>)" type="button" id="modifyQuoteGlobalById" class="test btn btn-primary">
					...
					<form class="row gy-3 gy-md-4 gy-lg-0 align-items-xl-center mx-2" id="form_quote">
								...
								<div class="col-12 col-lg-6">
									...
									<div class="row mt-4">
										<div class="col-4 mb-3">
											<button class="btn btn-warning" type="button" name="sauvegarder" value="sauvegarder">
												<i class="ace-icon fa fa-undo"></i>
												<span class="bigger-110">Void</span>
											</button>
										</div>
										<div class="col-4 mb-3">
											<button id="buttonPrintQuoteOnMenu" class="btn btn-light " type="button" name="sauvegarder" value="sauvegarder">
												<i class="ace-icon fa fa-print"></i>
												<span class="bigger-110">Print</span>
											</button>
										</div>
										<div class="col-4 mb-3">
											<button class="btn" style="background-color:grey; width: 120px;" type="button" name="sauvegarder" value="sauvegarder">
								...
								<div class="col-12 col-lg-6">
									<div class="row">
										<div class="col-4">
											...
											<input type="text" name="quote_id" id="quote_id" class="form-control form-control-sm" readonly>
										</div>
										<div class="col-4 ">
									...
									<div class="row input-group-sm mb-3">
										...
										<div class="card-body p-0 col-12 col-lg-9">
											...
											<select name="customers_id" id="customers_id" class="selectpicker form-select border-0 mb-1 rounded shadow" onchange="getSearchCustomerById(this.value)">
												...
												?>
													<option value="<?php echo $row['customers_id']; ?>"><?php echo $row['nom_compagnie']; ?></option>
												<?php } ?>
											</select>
											<input type="hidden" name="customers_id_selected" id="customers_id_selected">
										</div>
									</div>
						...
						<div class="col-12">
							<div class="row">
								...
								<div class="container col-sm-7 border border-primary rounded-3 px-3 py-3" style="background-color:powderblue">
							...
							<div class="modal-dialog modal-lg">
								<div class="modal-content">
													...
													<div class="row">
														<div class="col-12 col-lg-4">
															<div class="mb-3">
																...
																<select style="width: 100%;" id="itemname" name="itemname" class="let_choise1 form-select shadow" onchange="getSearchProductById(this.value)">
																	<option value="Select a product">Select a product</option>
																	<?php $query = mysqli_query($con, "select * from produit");
																	while ($row = mysqli_fetch_array($query)) {
																	?>
																		<option value="<?php echo $row['produit_id']; ?>"><?php echo $row['itemname']; ?></option>
																	<?php } ?>
																</select>
															</div>
														</div>
														...
														<div class="col-12 col-lg-8">
															<div class="mb-3">
																...
																<select style="width: 100%;" id="itemdescription" name="itemdescription" class="let_choise1 form-select shadow" onchange="getSearchProductById(this.value)">
																	<option selected value="Search by description">Search by description</option>
																	<?php $query = mysqli_query($con, "select * from produit");
																	while ($row = mysqli_fetch_array($query)) {
																	?>
																		<option value="<?php echo $row['produit_id']; ?>"><?php echo $row['itemdescription']; ?></option>
																	<?php } ?>
																</select>
																...
																while ($row = mysqli_fetch_array($query)) {
																?>
																	<input type="hidden" id="<?php echo "InputRow" . $row['produit_id']; ?>" name="<?php echo "InputRow" . $row['produit_id']; ?>" value="<?php echo $row['produit_id']; ?>">
																<?php } ?>
															</div>
														</div>
													</div>
												...
												<div class="col-12">
													<div>
														<div class="row">
																...
																<div class="row">
																	<div class="col-12 col-md-4 mb-3">
																		<div class="form-group">
																			...
																			<input type="text" name="onhandqty" id="onhandqty" class="form-control" readonly>
																		</div>
																	</div>
																	<div class="col-12 col-md-4 mb-3">
																		<div class="form-group">
																			<label for="stockdetail">Stock Detail</label>
																			<input type="text" name="stockdetail" id="stockdetail" class="form-control" readonly>
																		</div>
																	</div>
																	<div class="col-12 col-md-4 mb-3">
																		<div class="form-group">
																	...
																	<div class="col-12 col-md-4 mb-3">
																		<div class="form-group">
																			<label for="uom">UOM <span class="text-danger ps-2" id="uom_description"></span></label>
																			<select onchange="getChangeUOM(this.value)" name="uom" id="uom" class="form-select">
																				<option id="uom_1" value="UOM 1"></option>
																				<option id="uom_2" value="UOM 2"></option>
																			</select>
																		</div>
																	</div>
																	<div class="col-12 col-md-4 mb-3">
																		<div class="form-group">
																			...
																			<input type="text" name="sodetail" id="sodetail" class="form-control" readonly>
																		</div>
																	</div>
																	<div class="col-12 col-md-4 mb-3">
																		<div class="form-group">
																			<label for="regularprice">Regular Price</label>
																			<input type="text" name="regularprice" id="regularprice" class="form-control" readonly>
																		</div>
																	</div>
																	<div class="col-12 col-md-4 mb-3">
																		<div class="form-group">
																			<label for="quantity">Quantity</label>
																			<input type="text" name="quantity" id="quantity" class="form-control" autocomplete="off" autofocus>
																		</div>
																	</div>
																	<div class="col-12 col-md-4 mb-3">
																		<div class="form-group">
																	...
																	<div class="col-12 col-md-4 mb-3">
																		<div class="form-group">
																			...
																			<input type="text" name="productTotal" id="productTotal" class="form-control" readonly>
																		</div>
																	</div>
																</div>
															</div>
															<div class="col-12 col-lg-4">
																<div>
																	<input type="image" class="form-control form-control-sm" style="width: 20px; height:150px">
																</div>
															</div>
														</div>
													</div>
									...
									<div class="modal-footer">
										<div class="row">
											<div class="col-4">
												<button class="btn btn-success " type="button" id="save_product_modal" name="save_product_modal" value="sauvegarder"><i class="ace-icon fa fa-save"></i>
												</button>
											</div>

											<div class="col-4">
												<button class="btn btn-danger " type="button" class="btn btn-danger fa fa-exit" data-bs-dismiss="modal"><i class="ace-icon fa fa-sign-out"></i>
												</button>
											</div>
										</div>
									</div>
						...
						<!-- The Modal Modif -->
						<div class="addrecords modal fade" tabindex="-1" id="myModalModif" role="dialog" aria-hidden="true">
							<div class="modal-dialog modal-lg">
								<div class="modal-content">
													...
													<div class="row">
														<div class="col-12 col-lg-4">
															<div class="form-group mb-3">
																<label class="form-label" for="itemname_modify">Item Name</label>
																<input type="text" name="itemname_modify" id="itemname_modify" class="form-control" readonly>
															</div>
															<input type="hidden" name="quoteid_dt_modify" id="quoteid_dt_modify">
														</div>

														<div class="col-12 col-lg-8">
															<div class="form-group mb-3">
																<label class="form-label" for="itemdescription_modify">Item Description</label>
																<textarea name="itemdescription_modify" id="itemdescription_modify" class="form-control form-control-sm" rows="3" readonly></textarea>
															</div>
														</div>
													</div>
												</div>
														...
														<div class="row">
															<div class="col-12 col-lg-8">
																<div class="row">
																	<div class="col-12 col-md-4 mb-3">
																		<div class="form-group">
																			<label for="onhandqty_modify">On Hand qty.</label>
																			<input type="text" name="onhandqty_modify" id="onhandqty_modify" class="form-control" readonly>
																		</div>
																	</div>
																	<div class="col-12 col-md-4 mb-3">
																		<div class="form-group">
																			<label for="stockdetail_modify">Stock Detail</label>
																			<input type="text" name="stockdetail_modify" id="stockdetail_modify" class="form-control" readonly>
																		</div>
																	</div>
																	<div class="col-12 col-md-4 mb-3">
																		<div class="form-group">
																			<label for="barcode_modify">Bar Code</label>
																			<input type="text" name="barcode_modify" id="barcode_modify" class="form-control" readonly>
																		</div>
																	</div>
																	<div class="col-12 col-md-4 mb-3">
																		<div class="form-group">
																			<label for="uom_modify">UOM</label>
																			<select onchange="getChangeUOMProductModify(this.value)" name="uom_modify" id="uom_modify" class="form-select">
																				<option id="uom_1_modify" value="UOM 1"></option>
																				<option id="uom_2_modify" value="UOM 2"></option>
																			</select>
																		</div>
																	</div>
																	<div class="col-12 col-md-4 mb-3">
																		<div class="form-group">
																			<label for="sodetail_modify">S. O. Detail</label>
																			<input type="text" name="sodetail_modify" id="sodetail_modify" class="form-control" readonly>
																		</div>
																	</div>
																	<div class="col-12 col-md-4 mb-3">
																		<div class="form-group">
																			<label for="regularprice_modify">Regular Price</label>
																			<input type="text" name="regularprice_modify" id="regularprice_modify" class="form-control" readonly>
																		</div>
																	</div>
																	<div class="col-12 col-md-4 mb-3">
																		<div class="form-group">
																			<label for="quantity_modify">Quantity</label>
																			<input type="text" name="quantity_modify" id="quantity_modify" class="form-control" autocomplete="off" autofocus>
																		</div>
																	</div>
																	<div class="col-12 col-md-4 mb-3">
																		<div class="form-group">
																			<label for="unitprice_modify">Unit Price</label>
																			<input type="text" name="unitprice_modify" id="unitprice_modify" class="form-control" readonly>
																		</div>
																	</div>
																	<div class="col-12 col-md-4 mb-3">
																		<div class="form-group">
																			<label for="productTotal_modify">Total</label>
																			<input type="text" name="productTotal_modify" id="productTotal_modify" class="form-control" readonly>
																		</div>
																	</div>
																</div>
															</div>
									...
									<div class="modal-footer">
										<div class="row">
											<div class="col-4">
												<button class="btn btn-success " type="button" id="modifyQuoteById" name="modifyQuoteById" value="sauvegarder"><i class="ace-icon fa fa-save"></i>
												</button>
											</div>
					...
					<div class="row">
						...
						<div class="col-12 col-md-6 mb-2 mb-md-0">
							...
							<div>
								...
								honorColor: true, scanStyles: true, targetStyles: ['*'], css: '../ScCSS/print8x11.css' })">
						...
						<div class="col-12 col-md-6 mb-2 mb-md-0">
							...
							<div>
								...
								<button type="button" name="printPetit" class="btn btn-secondary"
									...
									onclick="printJS({ printable: 'print80', type: 'html', documentTitle: 'Quote', honorColor: true, scanStyles: true, targetStyles: ['*'], css: '../ScCSS/print80.css' })">
...
<div id="print80">
	...
	<div class="container">
		...
		<div class="billTo_80">
			...
			<div>
				Ship to
				<span style="display: block;  margin-top: 8px; margin-bottom: 20px; font-weight: 100" id="shipTo_80"></span>
			</div>
		...
		<div class="contenu-discount">
			<div class="border"></div>
			<div style="margin-left: 8px;"> <span class="dic"> Sub-Total : </span> <span class="disc" id="dt_totalItems_80"> </span> </div>
			<div> <span id="disc"> Disc % : &nbsp; <span id="dt_discountPourcentage_80"></span> </span> &nbsp;&nbsp;&nbsp;&nbsp; <span class="disc2"> Discount : </span> <span style="margin-left: 27px;" id="dt_discountAmount_80"> </span> </div>
			<div style="margin-left: 55px;"> <span> Tax : </span> <span class="disc" id="dt_taxes_80"> </span> </div>
			<div style="margin-left: 12px;"> <span> Shipping : </span> <span class="disc" id="dt_transport_80"> </span> </div>
			<div style="margin-left: 42px;"> <span> Total : </span> <span class="disc" id="dt_grandTotal_80"> </span> </div>
